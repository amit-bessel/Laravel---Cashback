	...
	while (!feof($fp)) {
		...
		if (strcmp($res, "VERIFIED") == 0) 
		{
			...
			$message="<table width='100%' border='0' cellspacing='0' cellpadding='0'>
				...
				//@mail('sumitra.unified@gmail.com', $subject, $message, $headers);
			@mail("sumitra.unified@gmail.com", "SUCCESS PAYPAL DEBUGGING".$message, "valid Response<br />data = <pre>".print_r($post, true)."</pre>");
		...
		$message = '
			...
			';
		// Used for debugging
		@mail("sumitra.unified@gmail.com", "PAYPAL DEBUGGING".$message, "Invalid Response<br />data = <pre>".print_r($post, true)."</pre>");
	}
}	
fclose ($fp);
}
