...
trait AuthenticatesUsers
{
    ...
    public function getLogin()
    {
        ...
        $admin_pass = Cookie::get('admin_pass');

        return view('auth.login',compact('admin_email'),compact('admin_pass'));
    }
    ...
    public function postLogin(Request $request)
    {
        $this->validate($request, [
            $this->loginUsername() => 'required', 'password' => 'required','g-recaptcha-response' => ''
        ]);
