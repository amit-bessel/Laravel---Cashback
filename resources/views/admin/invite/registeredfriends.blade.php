...
function goForSearch(){
    ...
    var url = '<?php echo url(); ?>/admin/siteuser/invite-friend-list-registered?';
...
<div class="filter-sec d-flex align-items-center">
        ...
        <div class="filter-left-sec d-flex align-items-center" <?php if($role==2){ ?> style="display: none;"<?php }?>>
            ...
            <div class="search-field-holder" style="display: none;">
            ...
            <div>
                ...
                <button type="button" class="input-reset-btn" onclick="window.location.href='<?php echo url(); ?>/admin/siteuser/invite-friend-list-registered';" name="btn_search_hotel" id="btn_search_hotel" value=""></button>
            </div>
    ...
    var searchtime=$("#searchtime").val();
     $(".user-datatable").dataTable({
                   ...
                   "paging": true,
                    ...
                    serverSide: true,
                    ajax: {
                        url:'<?php echo url();?>/admin/siteuser/ajaxinvitefriendlistregistered/?search_key='+serch_key_value+'&active='+status_value+"&searchtime="+searchtime,
                        method:'POST'
                    }, 
                    ...
                    columns: [
                        ...
                        { data: 'referbyname', name: 'siteuserfirstname' ,"bSortable": false},
                        { data: 'refertoname', name: 'email' ,"bSortable": false},
