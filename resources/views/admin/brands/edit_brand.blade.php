...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/cropperjs/0.8.1/cropper.css" />
   ...
   <script src="<?php echo url(); ?>/public/backend/scripts/main.js"></script>
	...
	{!! Form::open(['url' => 'admin/brands/edit/'.$brand_arr->id,'method'=>'POST', 'files'=>true,'class'=>'form-horizontal row-fluid','id'=>'cms_form','onsubmit'=>'category.checkBrandName("EDIT")']) !!}
		...
		{!! Form::hidden('hid_category_id',$brand_arr->id,['class'=>'span8','id'=>'hid_category_id']) !!}
		...
		<div class="control-group" style="display:block;">
			...
			<div class="controls">
				{!! Form::text('name',$brand_arr->brand_name,['class'=>'span8','id'=>'name']) !!}
		...
		<div class="control-group" style="display:block;">
			...
			<div class="controls">
				<textarea name="description" rows="10" class="span8 ckeditor"><?php echo $brand_arr->description; ?></textarea>
			</div>
		...
		<div class="control-group" style="display:block;">
			...
			<div class="controls">
				<input type="hidden" name="old_brand_image" value="<?php echo $brand_arr->featured_image ;?>">
			</div>
			<div class="controls">
    ...
    <div class="control-group" style="display:block;">
      ...
      <div class="controls">
        {!! Form::url('link',$brand_arr->link,['class'=>'span8','id'=>'link']) !!}
      </div>
		...
		<div class="control-group" style="display:block;">
			...
			<div class="controls">
				{!! Form::select('status', array('' =>'Status', '1' => 'Active', '0' => 'Inactive'),$brand_arr->status, array('class' => 'span3')) !!}
			</div>
                                 ...
                                 <!-- <h3>Toggles:</h3> -->
                                    <div class="btn-group docs-aspect-ratios" data-toggle="buttons">
                                      <label class="btn btn-primary active" id="activeAspectRatio1Default">
                                          <input type="radio" class="sr-only" id="aspectRatiodefault" name="aspectRatio" value="1.33333333333">
	...
	<script type="text/javascript">
		...
		$('#image_preview_div_men').html('<img class="img-responsive" src="<?php echo url(); ?>/uploads/brand_image/thumb/{{$brand_arr->featured_image}}" />');
