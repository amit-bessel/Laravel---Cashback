...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/cropperjs/0.8.1/cropper.css" />
   ...
   <script src="<?php echo url(); ?>/public/backend/scripts/main.js"></script>
	{!! Form::open(['url' => 'admin/vendors/edit/'.$vendor_id,'method'=>'POST', 'files'=>true,'class'=>'form-horizontal row-fluid','id'=>'cms_form','onsubmit'=>'category.checkCategoryName("EDIT")']) !!}
		...
		{!! Form::hidden('hid_vendor_id',$vendor_id,['class'=>'span8','id'=>'hid_vendor_id']) !!}
		
		<div class="control-group" style="display:block;">
			<label class="control-label" for="basicinput">Vendor Name *</label>
				
			<div class="controls">
				{!! Form::text('vendor_name',$vendor_details['advertiser-name'],['class'=>'span8','id'=>'vendor_name']) !!}
		...
		<div class="control-group" style="display:block;">
			<label class="control-label" for="basicinput">Vendor Url *</label>
				
			<div class="controls">
				{!! Form::text('vendor_url',$vendor_details['vendor_url'],['class'=>'span8','id'=>'vendor_url']) !!}
				<div style="color:#F00;font-size:13px;clear:both;display:none;" id="category_name_msg"></div>
			</div>
		...
		<div class="control-group" style="display:block;">
			...
			<div class="controls">
				{!! Form::text('percentage',$vendor_details['percentage'],['class'=>'span8','id'=>'percentage']) !!}
				<div style="color:#F00;font-size:13px;clear:both;display:none;" id="category_name_msg"></div>
			</div>
		...
		<div class="control-group" style="display:block;">
			...
			<div class="controls">
				{!! Form::textarea('description',$vendor_details['description'],['class'=>'span8 ckeditor','id'=>'description']) !!}
				<div style="color:#F00;font-size:13px;clear:both;display:none;" id="category_name_msg"></div>
			</div>
		...
		<div class="control-group" style="display:block;">
			...
			<div class="controls">
				{!! Form::textarea('short_description',$vendor_details['short_description'],['class'=>'span8 ckeditor','id'=>'short_description']) !!}
				<div style="color:#F00;font-size:13px;clear:both;display:none;" id="category_name_msg"></div>
			</div>
		...
		<div class="control-group" style="display:block;">
			...
			<div class="controls">
				{!! Form::select('status', array('' =>'Status', '1' => 'Active', '0' => 'Inactive'),$vendor_details['status'], array('class' => 'span3')) !!}
				<div style="color:#F00;font-size:13px;clear:both;display:none;" id="category_name_msg"></div>
			</div>
		...
		<div class="control-group" style="display:block;">
			...
			<div class="controls">
				<input type="hidden" name="old_brand_image" value="<?php echo $vendor_details['image'];?>">
				...
				<div style="color:#45a1e1;font-size:13px;clear:both;" id="category_name_msg">Please upload 145 X 110 px image for best view.</div>
        ...
        <?php if($vendor_details['api'] == 'CJ'){?>
				<!-- <span><img src="{{$vendor_details['api_image']}}"></span> -->
        <?php }?>
			</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<a href="{!! url('admin/vendors/list')!!}" class="btn">Back</a>
			</div>
                                 ...
                                 <!-- <h3>Toggles:</h3> -->
                                    <div class="btn-group docs-aspect-ratios" data-toggle="buttons">
                                      <label class="btn btn-primary active" id="activeAspectRatio1Default">
                                          <input type="radio" class="sr-only" id="aspectRatiodefault" name="aspectRatio" value="1">
	...
	<script type="text/javascript">
		...
		$('#image_preview_div_men').html('<img class="img-responsive" src="<?php echo url(); ?>/uploads/vendor_image/{{$vendor_details["image"]}}" />');
		...
		function closeModal(image_id,image_name){
			...
			$.ajax({
			  url:'<?php echo url(); ?>/admin/upload-image-vendor',
			  type:'POST',
			  data :image_info,
			  processData: false,
			  contentType: false,
			  success:function(dataname){
			    ...
			    $('#'+$('#image_preview_div').val()).html('<img class="img-responsive" src="<?php echo url(); ?>/uploads/vendor_image/' + dataname + '" />');
