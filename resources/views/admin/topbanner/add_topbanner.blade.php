...
@section('content')
   ...
   <script src="<?php echo url(); ?>/public/backend/scripts/main.js"></script>
	...
	{!! Form::open(['url' => 'admin/post-topbanner','method'=>'POST', 'files'=>true,'class'=>'form-horizontal row-fluid','id'=>'add_top_banner_form']) !!}
			...
			<div class="controls">
				...
				<div class="file-area">
					<div class="file-upload">
						<input type="file" id="files" onchange="initcroper(this.files,this.id,'image_preview_div_men','upload_banner_image','banner_img_error_men');"  name="banner_image"  class="photo-upload" style="display:block;"/>						             
					</div>
		...
		<div class="control-group" style="display:block;">
			...
			<div class="controls">
				{!! Form::text('banner_url_men','',['class'=>'span8','id'=>'banner_url_men']) !!}
			</div>
		</div>
		...
		<div class="control-group" style="display:block;">
			...
			<div class="controls">
				...
				<input type="file" id="Wfiles" onchange="initcroper(this.files,this.id,'image_preview_div_women','upload_banner_image_women','banner_img_error_women');"  name="banner_image_women"  class="photo-upload" style="display:block;"/>	
		...
		<div class="control-group" style="display:block;">
			...
			<div class="controls">
				{!! Form::text('banner_url_women','',['class'=>'span8','id'=>'banner_url_women']) !!}
			</div>
		</div>
			...
			reader.onload = function(_file) {
			    ...
			    image.onload = function() {
			        ...
			        if(w<960)
			        {
						...
						$('#'+banner_img_error).html("Image width should be minimum 960 px");
						show_pop_up = 0;
			        ...
			        if(h<260)
			        {
						...
						$('#'+banner_img_error).html("Image height should be minimum 260 px");
