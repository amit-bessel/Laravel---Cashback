...
@section('content')
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/cropperjs/0.8.1/cropper.css" />
   ...
   <script src="<?php echo url(); ?>/public/backend/scripts/main.js"></script>
	...
	{!! Form::open(['url' => 'admin/update-topbanner','method'=>'POST', 'files'=>true,'class'=>'form-horizontal row-fluid','id'=>'top_banner_form']) !!}
	
		{!! Form::hidden('banner_id',$banner_arr->id,['class'=>'span8','id'=>'banner_id']) !!}
		
		
			
		<div class="control-group" style="display:block;">
			<label class="control-label" for="basicinput">Banner for men</label>
			<div class="controls">
				<input type="file" id="banner_image" name="banner_image" onchange="initcroper(this.files,this.id,'image_preview_div_men','upload_banner_image','banner_img_error_men');"/>
				<div style="color:#45a1e1;font-size:13px;clear:both;" id="category_name_msg">Please upload 960 X 260 px image for best view.</div>
				<!-- <span id="banner_img_error" style="color:red"></span> -->
		...
		<div class="control-group" style="display:block;">
			<label class="control-label" for="basicinput">Banner url for men</label>
			<div class="controls">
				{!! Form::text('banner_url_men',$banner_arr->banner_url_men,['class'=>'span8','id'=>'banner_url_men']) !!}
			</div>
		</div>

		<div class="control-group" style="display:block;">
			<label class="control-label" for="basicinput">Banner for women</label>
			<div class="controls">

				<!-- <input type="file" id="banner_image_women" name="banner_image_women"/> -->


				<input type="file" id="Wfiles" onchange="initcroper(this.files,this.id,'image_preview_div_women','upload_banner_image_women','banner_img_error_women');"  name="banner_image_women" id="banner_image_women"  class="photo-upload" style="display:block;"/>	

				<div style="color:#45a1e1;font-size:13px;clear:both;">Please upload 960 X 260 px image for best view.</div>
				<span id="banner_img_error_women" style="color:red"></span>

				<span id="image_preview_div_women"></span>
		...
		<div class="control-group" style="display:block;">
			<label class="control-label" for="basicinput">Banner url for women</label>
			<div class="controls">
				{!! Form::text('banner_url_women',$banner_arr->banner_url_women,['class'=>'span8','id'=>'banner_url_women']) !!}
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				...
				<a href="{!! url('admin/topbanner-list')!!}" class="btn">Back</a>
			</div>
                                 ...
                                 <!-- <h3>Toggles:</h3> -->
                                    <div class="btn-group docs-aspect-ratios" data-toggle="buttons">
                                      <label class="btn btn-primary active" id="activeAspectRatio1Default">
                                          <input type="radio" class="sr-only" id="aspectRatiodefault" name="aspectRatio" value="2.627737226">
	...
	<script type="text/javascript">
		...
		$('#image_preview_div_men').html('<img class="img-responsive" src="<?php echo url(); ?>/uploads/banner_image/big/{{$banner_arr->banner_image}}" />');
		$('#image_preview_div_women').html('<img class="img-responsive" src="<?php echo url(); ?>/uploads/banner_image/big/{{$banner_arr->banner_image_women}}" />');
		...
		function closeModal(image_id,image_name){
			...
			$.ajax({
			  url:'<?php echo url(); ?>/admin/upload-image',
			  type:'POST',
			  data :image_info,
			  processData: false,
			  contentType: false,
			  success:function(dataname){
			    //alert(dataname);
			    $("#loader-image-sell-watch").hide();
			    $('#'+$('#image_preview_div').val()).html('<img class="img-responsive" src="<?php echo url(); ?>/uploads/banner_image/big/' + dataname + '" />');
