...
<div class="content-wrapper"> <!-- Content Wrapper. Contains page content -->
  ...
  <section class="content"><!-- Main content -->
    ...
    @endif
      <div class="row">
      {!! Form::open(['url' => 'admin/content/add-faq-question','method'=>'POST', 'files'=>true,'id'=>'cms']) !!}
        <div class="col-sm-12 col-md-6">
          <div class="form-group">
            <label>Question </label>
              {!! Form::text('question',null,['class'=>'form-control ','id'=>'question','required'=>true]) !!}
           </div>

           <div class="form-group">
            <label>Question </label>
              {!! Form::textarea('answer',null,['class'=>'form-control ','id'=>'answer','required'=>true]) !!}
           </div>
           <div class="form-group">
              <label></label>
