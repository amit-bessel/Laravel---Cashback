                                       ...
                                       <tbody>
                                          <tr>
                                             <td style="font-family:'Lato',sans-serif;font-weight:normal;border-collapse:collapse;vertical-align:top;padding:0px 20px 15px;margin:0;line-height:18px">
                                                <h1 style="font-family:'Lato',sans-serif;font-weight:normal;font-size:24px;line-height:28px;color:#666666"><span style="color:#B58324;">Hi</span> Admin,</h1>

                                                <p style="font-family:'Lato',sans-serif;font-weight:normal;font-size:16px;line-height:20px;color:#808080;margin:0;margin-bottom:20px;display:block;text-align:left;padding:0">Name : <?php echo $sender_name; ?></p>

                                                <p style="font-family:'Lato',sans-serif;font-weight:normal;font-size:16px;line-height:20px;color:#808080;margin:0;margin-bottom:20px;display:block;text-align:left;padding:0">Email : <?php echo $sender_email; ?></p>

                                                <p style="font-family:'Lato',sans-serif;font-weight:normal;font-size:16px;line-height:20px;color:#808080;margin:0;margin-bottom:20px;display:block;text-align:left;padding:0">Message: <?php echo $message_body; ?>.</p>
