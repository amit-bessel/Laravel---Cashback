...
@section('content')
	...
	{!! Form::open(['url' => 'admin/products/edit','method'=>'POST', 'files'=>true,'class'=>'form-horizontal row-fluid','id'=>'cms_form']) !!}
		...
		{!! Form::hidden('search_key',$search_key,['class'=>'span8','id'=>'search_key']) !!}
		{!! Form::hidden('active',$active,['class'=>'span8','id'=>'active']) !!}
		{!! Form::hidden('srch_category_id',$srch_category_id,['class'=>'span8','id'=>'srch_category_id']) !!}
		{!! Form::hidden('srch_brand_id',$srch_brand_id,['class'=>'span8','id'=>'srch_brand_id']) !!}
		{!! Form::hidden('srch_vendor_id',$srch_vendor_id,['class'=>'span8','id'=>'srch_vendor_id']) !!}
		...
		<div class="control-group" style="display:block;">
			...
			<div class="controls">
				<textarea name="description" id="description" rows="5" class="span8 valid"><?php $details =unserialize($product_details['description']);
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<a href="<?php echo url().'/admin/products/list/?search_key='.$search_key.'&active='.$active.'&srch_category_id='.$srch_category_id.'&srch_brand_id='.$srch_brand_id.'&srch_vendor_id='.$srch_vendor_id; ?>" class="btn">Back</a>
			</div>
