...
@section('content')
	...
	{!! Form::open(['url' => 'admin/category/add','method'=>'POST', 'files'=>true,'class'=>'form-horizontal row-fluid','id'=>'cms_form','onsubmit'=>'category.checkCategoryName("ADD")']) !!}
		...
		<div class="control-group" style="display:block;">
			...
			<div class="controls">
				{{ isset($brand_details['brand_name'])?$brand_details['brand_name']:'Unknown'}}
			</div>
		...
		<div class="control-group" style="display:block;">
			...
			<div class="controls">
			<?php $details =unserialize($product_details['description']);
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<!-- <a href="{!! url('admin/products/list')!!}" onclick="window.history.back();" class="btn">Back</a> -->
				<a href="javascript:void(0);" onclick="window.history.back();" class="btn">Back</a>
			</div>
