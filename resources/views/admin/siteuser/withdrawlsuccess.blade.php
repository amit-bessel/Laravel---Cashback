...
function goForSearch(){
   ...
   // var is_active       = $('#is_active').val();
    var url = '<?php echo url(); ?>/admin/userwithdrawl/success?';
        ...
        <span class="input-group-addon add-on" style="/*padding-right: 20px;*/"><span class="glyphicon glyphicon-calendar"></span></span></div>
          ...
          <!--   <div class="custom-select-holder">
            ...
            <div>
                ...
                <button type="button" class="input-reset-btn" onclick="window.location.href='<?php echo url(); ?>/admin/userwithdrawl/success';" name="btn_search_hotel" id="btn_search_hotel" value=""></button>
            </div>
...
<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-striped  display user-datatable" width="100%">
    <thead>
        <tr style="color:#FFFFFF; background:#141b27;">
            <th widht="1%" style="align:center;" >
                <input type="checkbox" name="check_all_records" id="check_all_records" onclick="selectAllRecords();"  style=" visibility: hidden;" />
            </th>
            <th width="28%">Name</th>
    ...
    var enddate=$("#enddate").val();
     $(".user-datatable").dataTable({
                   ...
                   "paging": true,
                    ...
                    serverSide: true,
                    ajax: {
                        url:'<?php echo url();?>/admin/userwithdrawl/ajax-withdrawl-success/?search_key='+serch_key_value+"&startdate="+startdate+"&enddate="+enddate,
                        method:'POST'
                    }, 
                    ...
                    columns: [
                        ...
                        { data: 'senderbatchid', name: 'senderbatchid' ,"bSortable": false},
