...
<!-- jQuery Form Validation code -->
  ...
  $(function() {
    ...
    function validate_city_info(){
      //alert('Hi');
		...
		if(country_id!='' && name!=''){
			//alert(base_url+'check-city-availability');
			$.ajax({
				type	: 'GET',
  ...
  <?php //echo "<pre>";print_r($hotel_details);exit(); ?>
        {!! Form::open(['url' => 'admin/Add-state/'.$country_id,'method'=>'POST', 'files'=>true,'class'=>'form-horizontal row-fluid','id'=>'cms_form','onsubmit'=>'validate_city_info();']) !!}
           ...
           <div class="control-group" style="display:block;">
                ...
                <div class="controls">
                    <select name="country_id" id="country_id" disabled="disabled">
            ...
            <div class="control-group" style="display:block;">
                ...
                <div class="controls">
                    <input type="text" name="name" id="name" value="" class="span8">
