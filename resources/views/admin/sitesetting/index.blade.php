...
function goForSearch(){
    ...
    var url = '<?php echo url(); ?>/admin/sitesetting?';
...
<div class="filter-sec d-flex align-items-center">
        ...
        <div class="filter-left-sec d-flex align-items-center" >
            ...
            <div>
                ...
                <button type="button" class="input-reset-btn" onclick="window.location.href='<?php echo url(); ?>/admin/sitesetting';" name="btn_search_hotel" id="btn_search_hotel" value=""></button>
            </div>
			...
			<table cellpadding="0" cellspacing="0" border="0" class="table table-striped  display" width="100%">
				...
				<tbody>
					...
					<tr class="odd gradeX">
						...
						<td>
							<a class="edit-icon" href="{!!route('admin.sitesetting.edit',$sitesetting->id)!!}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
						</td>
					   <!-- <td>
