...
function goForSearch(){
    ...
    var url = '<?php echo url(); ?>/admin/user/transactions?';
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%"> 
        ...
        <tr>
            <td width="30%" style="padding:0px;">
                ...
                <input type="button" onclick="window.location.href='<?php echo url(); ?>/admin/user/transactions';" class="btn" name="btn_search_hotel" id="btn_search_hotel" value="Reset" />
            </td>
        </tr>
    </table>
</div>

{!! Form::open(['url' => 'admin/user/transactions','method'=>'POST', 'files'=>true,'class'=>'form-horizontal row-fluid','id'=>'cms_form']) !!}
<div class="module">
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-striped  display user-datatable" width="100%">
        <thead>
            <tr style="color:#FFFFFF; background:#444;">
                ...
                <th width="15%">Sku Number</th>
                <th width="20%">Date & Time</th>
                <th width="10%">Sale Amount</th>
                <th width="10%" align="center">Cashback</th>
        ...
        <tbody>
            ...
            @foreach ($all_tranctions as $v)
                ...
                <td class="">{{ $v['sku_number'] }}</td>
                <td class="" style="text-align:center;">
                    {{date('d-m-Y H:i:s',strtotime($v['transaction_date']))}}
                </td>
               ...
               <td class="" style="text-align:center;">
                    <a href="<?php echo url(); ?>/admin/user/tranctions/{{ base64_encode($v['id']) }}"><i class="fa fa-eye" aria-hidden="true"></i></a>
                </td>
