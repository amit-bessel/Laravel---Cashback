...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/cropperjs/0.8.1/cropper.css" />
   ...
   <script src="<?php echo url(); ?>/public/backend/scripts/main.js"></script>
	{!! Form::open(['url' => 'admin/category/edit/'.$category_id,'method'=>'POST', 'files'=>true,'class'=>'form-horizontal row-fluid','id'=>'cms_form']) !!}
		...
		{!! Form::hidden('sub_cat_as_cat',$sub_cat_as_cat,['class'=>'span8','id'=>'sub_cat_as_cat']) !!}
		...
		<div class="control-group" style="display:block;">
			<label class="control-label" for="basicinput">Featured Image For Men</label>
			<div class="controls">
				<input type="hidden" name="old_category_image_men" value="<?php echo $category_details->featured_image ;?>">
			</div>	
			<div class="controls">
				<input type="file" name="featured_image" id="featured_image" class="span3" onchange="initcroper(this.files,this.id,'image_preview_div_men','upload_banner_image','banner_img_error_men');"> 
		...
		<div class="control-group" style="display:block;">
			<label class="control-label" for="basicinput">Image link for men</label>
				
			<div class="controls">
				{!! Form::text('image_url_men',$category_details->image_url_men,['class'=>'span8','id'=>'image_url_men']) !!}
				<div style="color:#F00;font-size:13px;clear:both;display:none;" id="category_name_msg"></div>
			</div>
		...
		<div class="control-group" style="display:block;">
			<label class="control-label" for="basicinput">Image caption for men</label>
				
			<div class="controls">
				{!! Form::text('image_caption_men',$category_details->image_caption_men,['class'=>'span8','id'=>'image_caption_men']) !!}
				<div style="color:#F00;font-size:13px;clear:both;display:none;" id="category_name_msg"></div>
			</div>
		...
		<div class="control-group" style="display:block;">
			<label class="control-label" for="basicinput">Featured Image For Women</label>
			<div class="controls">
				<input type="hidden" name="old_category_image_women" value="<?php echo $category_details->featured_image_women ;?>">
			</div>	
			<div class="controls">
				<input type="file" name="featured_image_women" id="featured_image_women" class="span3" onchange="initcroper(this.files,this.id,'image_preview_div_women','upload_banner_image_women','banner_img_error_women');"> 

				<span id="img_msg" style="display:block;"></span>
				<span id="image_preview_div_women" class="coomonimgclass"></span>
				<input type="hidden" id="upload_banner_image_women" name="upload_banner_image_women"/>
				<span id="banner_img_error_women" style="color:red"></span>
			</div>
				
		</div>

		<div class="control-group" style="display:block;">
			<label class="control-label" for="basicinput">Image link for women </label>
				
			<div class="controls">
				{!! Form::text('image_url_women',$category_details->image_url_women,['class'=>'span8','id'=>'image_url_women']) !!}
				<div style="color:#F00;font-size:13px;clear:both;display:none;" id="category_name_msg"></div>
			</div>
		...
		<div class="control-group" style="display:block;">
			<label class="control-label" for="basicinput">Image caption for women</label>
				
			<div class="controls">
				{!! Form::text('image_caption_women',$category_details->image_caption_women,['class'=>'span8','id'=>'image_caption_women']) !!}
				<div style="color:#F00;font-size:13px;clear:both;display:none;" id="category_name_msg"></div>
			</div>
                                 ...
                                 <!-- <h3>Toggles:</h3> -->
                                    <div class="btn-group docs-aspect-ratios" data-toggle="buttons">
                                      <label class="btn btn-primary active" id="activeAspectRatio1Default">
                                          <input type="radio" class="sr-only" id="aspectRatiodefault" name="aspectRatio" value="1.3333333333">
	...
	<script type="text/javascript">
		...
		$('#image_preview_div_men').html('<img class="img-responsive" src="<?php echo url(); ?>/uploads/category_image/thumb/{{$category_details->featured_image}}" />');
		$('#image_preview_div_women').html('<img class="img-responsive" src="<?php echo url(); ?>/uploads/category_image/thumb/{{$category_details->featured_image_women}}" />');
		...
		function closeModal(image_id,image_name){
			...
			$.ajax({
			  url:'<?php echo url(); ?>/admin/upload-image-category',
			  type:'POST',
			  data :image_info,
			  processData: false,
			  contentType: false,
			  success:function(dataname){
			    ...
			    $('#'+$('#image_preview_div').val()).html('<img class="img-responsive" src="<?php echo url(); ?>/uploads/category_image/thumb/' + dataname + '" />');
