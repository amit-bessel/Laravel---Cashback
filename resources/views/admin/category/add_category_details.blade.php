	...
	{!! Form::open(['url' => 'admin/category/add','method'=>'POST', 'files'=>true,'class'=>'form-horizontal row-fluid','id'=>'cms_form','onsubmit'=>'category.checkCategoryName("ADD")']) !!}
		...
		@if(Session::has('failure_message'))
				...
				<div class="control-group" style="display:block;">
					...
					<div class="controls">
						<label>Men<input type="checkbox" name="gender[]" value="1"></label>
						<label>Women<input type="checkbox" name="gender[]" value="2"></label>
		...
		<div class="control-group" style="display:block;">
			...
			<div class="controls">
				{!! Form::text('image_url_men','',['class'=>'span8','id'=>'image_url_men']) !!}
				<div style="color:#F00;font-size:13px;clear:both;display:none;" id="category_name_msg"></div>
			</div>
		...
		<div class="control-group" style="display:block;">
			...
			<div class="controls">
				{!! Form::text('image_caption_men','',['class'=>'span8','id'=>'image_caption_men']) !!}
				<div style="color:#F00;font-size:13px;clear:both;display:none;" id="category_name_msg"></div>
			</div>
		...
		<div class="control-group" style="display:block;">
			...
			<div class="controls">
				{!! Form::text('image_url_women','',['class'=>'span8','id'=>'image_url_women']) !!}
				<div style="color:#F00;font-size:13px;clear:both;display:none;" id="category_name_msg"></div>
			</div>
		...
		<div class="control-group" style="display:block;">
			...
			<div class="controls">
				{!! Form::text('image_caption_women','',['class'=>'span8','id'=>'image_caption_women']) !!}
				<div style="color:#F00;font-size:13px;clear:both;display:none;" id="category_name_msg"></div>
			</div>
                                 ...
                                 <!-- <h3>Toggles:</h3> -->
                                    <div class="btn-group docs-aspect-ratios" data-toggle="buttons">
                                      <label class="btn btn-primary active" id="activeAspectRatio1Default">
                                          <input type="radio" class="sr-only" id="aspectRatiodefault" name="aspectRatio" value="1.33333333">
