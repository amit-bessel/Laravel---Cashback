            ...
            <div class="category-description">
                <div class="row table-prop">
                    <div class="col-sm-6 col-sm-push-6 right-categoryimg table-cell">
                        ...
                        <a href="{{$brand_details['link']?$brand_details['link']:'javascript:void(0)'}}" target="_blank"><img src="{{url()}}/uploads/brand_image/thumb/{{$brand_details['featured_image']?$brand_details['featured_image']:'no-image.png'}}" class="img-responsive"></a>
                    </div>
          ...
          <div class="table-prop">              
            ...
            <div class="col-sm-8 col-md-9 table-cellspecial">
                ...
                <div class="product-list">
                    <div class="loader_list text-center">
                        <img src="<?php echo url();?>/public/frontend/images/Loading_icon.gif" alt="">
                   </div>
