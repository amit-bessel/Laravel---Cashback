                ...
                <div class="col-sm-6 herw-two-lft">                    
                    <div class="new-contentpartner text-center">
                        ...
                        <?php if(Session::has('user_id')){ ?>
                                <a class="btn btn-primary btn-block" href="{{url()}}/stores/click/{{$vendor_details['id']}}" target="_blank">Go to the {{$title}}</a>
                ...
                <div class="vendor-cell">
                  ...
                  <div class="vendor-content">
                    ...
                    <div class="bottom-text">
                      <span><img src="{{url()}}/uploads/vendor_image/{{$store['image']}}" alt="" height="50px" width="115px" alt=""></span>
                    </div>
                  </div>
                </div>
              </div>
