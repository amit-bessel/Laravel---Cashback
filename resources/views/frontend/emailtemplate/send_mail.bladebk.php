                           ...
                           <tbody>
                              <tr>
                                 <td style="font-family:'Lato',sans-serif;font-weight:normal;border-collapse:collapse;vertical-align:top;padding:0;margin:0;width:40%">
                                   <a href="<?php echo url();?>" style="color:#fff;text-decoration:none" target="_blank"><img src="<?php echo url();?>/public/frontend/images/logo_2.png" style="max-width: 150px;height:auto;" alt="" style="text-align:center;"></a>
                                       ...
                                       <tbody>
                                          <tr>
                                             <td style="font-family:'Lato',sans-serif;font-weight:normal;border-collapse:collapse;vertical-align:top;padding:0px 20px 15px;margin:0;line-height:18px">
                                                <h1 style="font-family:'Lato',sans-serif;font-weight:normal;font-size:24px;line-height:28px;color:#666666"><span style="color:##B58324;">Hi</span> <?php echo $user_name; ?>,</h1>
                           ...
                           <tbody>
                              <tr>
                                 <td align="center" style="font-family:'Lato',sans-serif;font-size:14px;font-weight:normal;border-collapse:collapse;vertical-align:top;padding:0;margin:0;padding-bottom:10px">
                                    <p style="font-family:'Lato',sans-serif;font-size:14px;color:#fff;">© Copyright <?php echo date('Y'); ?> <a style="color:#fff;text-decoration:none;" href="<?php echo url();?>">www.checkoutsaver.com</a>
                                 </td>
                              </tr>
                           </tbody>
                        </table>
